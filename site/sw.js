...
const VERSION = 'ladoga-v39';
const SHELL = ['./', 'index.html', 'log.js', 'app.js', 'wave.js', 'content.js', 'tracks.js', 'retrace.js', 'geo.js', 'ui.js', 'simple.js', 'styles.css', 'manifest.webmanifest', 'icons/icon.svg', 'icons/icon-192.png', 'icons/icon-512.png', 'icons/icon-maskable-512.png',
  ...
  'data/points.json', 'data/context.json', 'data/reeds.json', 'tiles/depth_cover.json', 'tiles/charts_cover.json', 'data/depth_dangers.json'];
