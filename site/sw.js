...
const VERSION = 'ladoga-v29';
const SHELL = ['./', 'index.html', 'app.js', 'wave.js', 'content.js', 'tracks.js', 'geo.js', 'ui.js', 'styles.css', 'manifest.webmanifest', 'icons/icon.svg', 'icons/icon-192.png', 'icons/icon-512.png', 'icons/icon-maskable-512.png',
  ...
  'data/points.json', 'data/context.json', 'tiles/depth_cover.json'];
